...
export const productionContainerModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    const workspaceService = new WorkspaceServiceClient("content-service:8080", grpc.credentials.createInsecure())
    bind(WorkspaceServiceClient).toConstantValue(workspaceService);
